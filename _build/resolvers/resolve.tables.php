...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('currencycalc_core_path', null,
                    $modx->getOption('core_path') . 'components/currencycalc/') . 'model/';
            $modx->addPackage('currencycalc', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/currencycalc/model/schema/currencycalc.mysql.schema.xml';
